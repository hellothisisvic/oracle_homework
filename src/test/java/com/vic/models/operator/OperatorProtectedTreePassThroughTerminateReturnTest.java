...
public class OperatorProtectedTreePassThroughTerminateReturnTest {
    ...
    public void shouldGenerateMovePathCorrectly() {
        ...
        Assert.assertEquals(5, movePathDTOList.size());
        Assert.assertEquals("advance 1", movePathDTOList.get(0).getReportFormatString());
        ...
        Assert.assertEquals("advance 3", movePathDTOList.get(4).getReportFormatString());
    }
}
